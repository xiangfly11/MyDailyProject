...
-(void) createViews {
    ...
    UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0,topNavScrollBarHeight, kScreenWidth, kScreenHeight - 3 *topNavScrollBarHeight) collectionViewLayout:flowLayout];
